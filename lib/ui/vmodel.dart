...
class Vmodel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const ExperienceItem(
      ...
      summary: [
        "Vmodel is a digital booking solution that leverages the power of technology and social media to connect micro-influencers to brands and opportunities"
